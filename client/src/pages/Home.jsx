            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  fugiat reprehenderit possimus, nisi, accusamus repudiandae
                  laudantium sit voluptatum, culpa ex adipisci autem suscipit
                  assumenda consectetur a temporibus minima dolorum ipsam.
                </p>
              ...
              >
                <div>
                  ...
                  <p className="text__para">Years of Experiment</p>
                </div>
          ...
          >
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid border-
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            [100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]"
              >
                ...
                bg-yellowColor rounded p y-1 px-[60px] lg:py-3 lg:px-[9px]"
                  >
                ...
                <div
                  className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-
